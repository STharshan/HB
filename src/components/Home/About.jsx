...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Great garage, very professional and reliable. Experienced and trustworthy technicians. All work invoiced and insured. Extremely fast but very busy. Best garage in the area.",
    name: "Michał Dawidowski",
  },
